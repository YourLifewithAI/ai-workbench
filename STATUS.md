...
**Gates:** `npm run check` green (unit 141 · security 179 · contract 52) · every `tests/dod/RUN-*.test.ts` suite green on both tested platforms (DoD 07-2 is live-only) · `npm run e2e` 52 passed · Docker smoke and a no-sandbox job: CI
