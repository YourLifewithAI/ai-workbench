...
| SEC-46 | A detached child cannot escape budget: `wait: false` charges the carved budget to the parent as a reservation at dispatch, a model call in any descendant run counts against every ancestor agent's own daily and monthly caps, depth is refused past three, and a child of a finished parent runs to completion inside its carve (D-76) | 24 |
